...
////
////trait CityMapping[F[_]] extends DoobieMapping[F] {
...
////      type Query {
////        city(id: Long!): City
////        cities(countryId: Long, isCapital: Boolean): [City]
////      }
////
////      type City {
////        id: Long!
...
////          SqlField("countryId", city.countryId),
...
////          ).success
////      },
////      CityType -> { case Select("countryId", args, child) =>
////        Select(
////          "country",
////          Nil,
////          Filter(Eql(CountryType / "id", Const(countryId)), child)
////        ).success
////      }
////    )
////  )
